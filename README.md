...
- **[AI Agents Masterclass](https://github.com/coleam00/ai-agents-masterclass)** — a beginner-friendly episodic series with full code walkthroughs to build AI agents. The course covers LangChain, LangGraph, RAG techniques, n8n workflow agents. Each episode is accompanied by the exact code used in the videos.
